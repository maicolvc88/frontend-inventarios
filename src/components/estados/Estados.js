...
import { obtenerEstados, crearEstado, editarEstadosID, borrarEstadosID, } from '../../services/EstadoService'
import HeaderTable from '../ui/HeaderTable'
import Modal from '../ui/Modal'

export default function TipoEstados() {
  ...
  const borrarEstado = async (e) => {
    ...
    try{
      ...
      console.log(id)
      const res = await borrarEstadosID(id)
      console.log(res)
      listEstados();
      setLoading(false)
    }catch(e){
  ...
  const editarEstado = async (e) => {
    ...
    try{
      setError(false)
      const resp = await editarEstadosID(estado._id, estado);
      console.log(resp)
      resetEstado()
      listEstados()
    }catch(e){
  ...
  const setEstadoPorId = (e) => {
    ...
    const tiposFilter = estado.filter(t => t._id === e.target.id);
