...
import { borrarMarcasID, crearMarca, editarMarcasID, obtenerMarcas } from '../../services/MarcaService'
import HeaderTable from '../ui/HeaderTable'
import Modal from '../ui/Modal'

export default function Marcas() {

  const [Mmarcas, setMarcas] = useState([])
  ...
  const borrarMarca = async (e) => {
    ...
    try{
      ...
      console.log(id)
      const res = await borrarMarcasID(id)
      console.log(res)
      listMarcas();
      setLoading(false)
    }catch(e){
  ...
  const editarMarca = async (e) => {
    ...
    try{
      setError(false)
      const resp = await editarMarcasID(marca._id, marca);
      console.log(resp)
      resetMarca()
      listMarcas()
    }catch(e){
  ...
  const setMarcaPorId = (e) => {
    ...
    const tiposFilter = Mmarcas.filter(t => t._id === e.target.id);
